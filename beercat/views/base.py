...
class GenericMixin:
    ...
    def model(self):
        ...
        if self.kwargs.get('model', None):
            return apps.get_model("beercat", self.kwargs['model'])
        else:
            return self._model
...
class InlineActionMixin:
    ...
    def parent(self):
        ...
        parent_model = apps.get_model("beercat", self.kwargs['parent_model'])
...
class ReprMixin:
    ...
    def repr(self, obj):
        ...
        return render_to_string("snippets/title/base.html", {'obj': obj})
...
class CreateView(GenericMixin, BaseCreateView, CTypeMixin):
    ...
    def permission(self):
        ...
        return "beercat.add_%s" % self.ctype
...
class UpdateView(GenericMixin, BaseUpdateView, CTypeMixin):
    ...
    def permission(self):
        ...
        return "beercat.change_%s" % self.ctype
...
class DetailView(GenericMixin, ReprMixin, BaseDetailView, CTypeMixin):
    ...
    def permission(self):
        ...
        return "beercat.view_%s" % self.ctype
...
class ListingView(GenericMixin, FormView, CTypeMixin):
    ...
    permission = "beercat.manage_products"
